        ...
        fulfillment_messages: [
          {
            text: {
              text: [
                "Desculpe, o sistema não respondeu! Volte mais tarde, por gentileza.",
              ],
            },
          },
        ],
    ...
    try {
      ...
      jsonResponse = {
        fulfillment_messages: [
          {
            text: {
              text: ["Desculpe, ocorreu um erro ao processar as respostas.😐"],
            },
          },
        ],
      };
